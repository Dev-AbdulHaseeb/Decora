    ...
    <>
      <div className="container">
        <div className="grid grid-cols-1 md:grid-cols-2 md:min-h-[500px] gap-10">
          {/* Text Section  */}
          <div className="flex flex-col justify-center gap-7 md:pr-8 lg:pr-14 text-center md:text-left pt-20 md:pt-0 px-10">
            <motion.h1
            ...
            <motion.p
              ...
              initial="initial"
              animate="animate"
              className="text-sm md:text-base text-gray-600 leading-7"
            >
